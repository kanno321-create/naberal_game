...
```mermaid
graph TD
    G[Wave 1 Geographer] --> PC[Wave 2 Political-Cartographer]
    G --> TO[Wave 2 Toponymist]
    G --> RE[Wave 2 Road-Engineer]
    G --> EC[Wave 2 Economist]
    G --> CU[Wave 2 Culturalist]
    PC --> HI[Wave 3 Historian]
    PC --> DI[Wave 3 Diplomat]
    CU --> HI
    EC --> DI
    HI --> KD[Wave 4 Kingdom-Detailer × 12]
    DI --> KD
    PC --> KD
    TO --> KD
    KD --> CH[Wave 5 Chronicler]
    KD --> WI[Wave 5 World-Integrator]
    HI --> CH
    DI --> WI
```
