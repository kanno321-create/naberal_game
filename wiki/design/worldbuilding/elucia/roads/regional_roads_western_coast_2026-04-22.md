---
title: "서해안 연안 도로 — Silvan·Loravel·Havren 권역"
type: road
road_class: regional
kingdom: ilaris_ceren_moran_aldric
created: 2026-04-22
updated: 2026-04-22
...
```mermaid
graph TB
    MOR_P[Moran Havrenport]
    MIR[Mirevane Bay 무역항]
    SIL_P[Silvanport — Ilaris 수도]
    CAPE[Silvan Cape 반도 어항군]
    DELTA[Loravel Delta 하구항]
    CER[Ceren 수도]

    MOR_P -->|RW-01 절벽도| MORAN_NORTH[북서 절벽 어항]
    MOR_P -->|RW-04 남진| MIR
    MIR -->|RW-04 계속| SIL_P
    SIL_P -->|RW-03 반도 순환| CAPE
    CAPE -->|RW-03 복귀| SIL_P
    SIL_P -->|RW-04 남진| DELTA
    DELTA -->|RW-05| CER

    SIL_P -->|VI-W 연결| SOL[Solaris ★]
    MIR -->|Eloryn 강 수운| SOL
```
