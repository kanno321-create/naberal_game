---
title: "Via Imperialis — 제국 방사형 대로"
layer: 2
canon_tier: detail
...
```mermaid
graph TD
    SOL[★ Solaris 수도 — Via Imperialis 중심]
    SOL -->|VI-N 북간선 620km| GGP[Greygate Pass 남문]
    SOL -->|VI-NW 북서간선 480km| MOR[Moran 수도 Havrenport]
    SOL -->|VI-W 서간선 380km| ILA[Ilaris 수도 Silvanport]
    SOL -->|VI-S 남간선 700km| AZN[Azim Pass 북단]
    SOL -->|VI-E 동간선 420km| ORY[Oryn 수도 Orenhold]
    GGP -->|Greygate Pass| THA[Thaloss 북부]
    AZN -->|Azim Pass 대로| KAR[Karzor / Sabin]
    ILA -.->|해로 접속| SEA[서해 무역항]
    MOR -.->|해로 접속| NOR[북서 어항]
```
