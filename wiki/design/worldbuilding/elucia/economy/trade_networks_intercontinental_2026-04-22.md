...
type: economy
subject: trade_networks_intercontinental
created: 2026-04-22
...
```mermaid
graph LR
    EL[Elucia 11 왕국] -->|양모·철·직물| NM[Nomen 섬 시장]
    KZ[Karzor 왕조] -->|어류·향신료·피혁| NM
    NM -->|상호 교환| EL
    NM -->|상호 교환| KZ
    EL -->|군수·가축·노예| AZ[Azim Pass]
    KZ -->|군수·노예| AZ
    AZ -->|교역·전쟁 교대| EL
    AZ -->|교역·전쟁 교대| KZ
```
