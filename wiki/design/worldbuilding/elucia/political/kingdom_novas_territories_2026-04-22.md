...
```mermaid
graph LR
    DF[Duskfell Range 구릉] -->|동쪽 방벽| NO[Novas 왕국]
    DW[Duskway 강] -->|남동 수계| NO
    NO -->|평원 접경| SY[Sylren 왕국]
    NO -->|숲 접경| OR[Oryn 왕국]
    NO -->|평원 접경| AL[Aldric 왕국]
    NO -->|관문| AZ[Azim Pass 남부 연결]
```
