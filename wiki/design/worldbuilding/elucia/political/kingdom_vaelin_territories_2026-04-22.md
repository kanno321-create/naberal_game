...
```mermaid
graph LR
    NR[Norvend Range 북방 장벽] -->|Greygate Pass 1,600m| VA[Vaelin 왕국]
    VA -->|Eloryn 강 동류| CH[성좌국 방향]
    VA -->|Mornwell 강 공유| MO[Moran 왕국]
    VA -->|평원 접경| TH[Thaloss 왕국]
    VA -->|평원 접경| MA[Maerith 왕국]
```
