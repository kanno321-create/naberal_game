...
```mermaid
graph LR
    LO[Lowen 강 동→서 수운] -->|호수 유입| AL[Aldric 왕국]
    LB[Lonwyn Basin 호수군] -->|국토 핵심| AL
    AL -->|호수 접경| CE[Ceren 왕국]
    AL -->|평원 접경| SY[Sylren 왕국]
    AL -->|남부 해안| SW[서남 해]
    AL -->|Azim 방향| AZ[Azim Pass 방향]
```
