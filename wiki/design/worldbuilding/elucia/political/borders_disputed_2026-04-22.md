...
type: political
subject: borders_disputed
created: 2026-04-22
agent: Wave2-Political-Cartographer
wave: 2
inputs:   - wiki/design/worldbuilding/elucia/political/borders_natural_2026-04-22.md
...
graph TD
    ...
    D -->|자원 분쟁| R[강·숲·광산 권리]
    D -->|전략 분쟁| S[관문·고개 통제권]
    D -->|종교 분쟁| RE[교황청 성좌세·교구 관할]
    D -->|타종족 관련| T[은신지 관할·박해 대상 결정]
    D -->|대륙 간| I[Azim Pass 동서 충돌]
```
