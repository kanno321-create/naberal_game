---
title: "Elucia 자연 국경 체계"
type: political
subject: borders_natural
created: 2026-04-22
updated: 2026-04-22
...
inputs:
  ...
  - wiki/design/worldbuilding/elucia/geography/rivers_tributaries_2026-04-22.md
...
```mermaid
graph TD
    VG[Veilglass 얼음섬] -->|북방 해양 장벽| NR[Norvend Range 북부 장벽]
    NR -->|동서 900km 절대 방벽| TH[Thaloss 왕국 북부 보호]
    NR -->|3개 고개 통제점| GP[Greygate·Ironcleft·Whitecrest]
    GR[Veilorn Ridge 동부 장벽] -->|남북 700km| OR[Oryn 동쪽 경계]
    GR -->|Karzor 건조 기류 차단| OW[Orenwald 숲 수분 보존]
    EL[Eloryn 강] -->|국경 후보| VA_CH[Vaelin–성좌국]
    LO[Lowen 강] -->|동서 국경 후보| CH_AL[성좌국–Aldric]
    SO[Soranth 강] -->|국경 후보| OR_SY[Oryn–Sylren]
    AZ[Azim Pass] -->|남단 관문| NO[Novas 왕국 제어]
```
