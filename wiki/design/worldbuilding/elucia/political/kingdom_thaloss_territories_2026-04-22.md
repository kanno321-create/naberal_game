---
title: "Thaloss 왕국 — 내부 공작령·백작령 체계"
type: political
kingdom: thaloss
created: 2026-04-22
updated: 2026-04-22
...
```mermaid
graph TD
    VG[Veilglass 방향 — 사실상 진입 불가] -->|북쪽 장벽| NR[Norvend Range]
    NR -->|서쪽 1/3 Greygate Pass| GW[Vaelin·Moran 접경]
    NR -->|중앙 Ironcleft Pass| CM[성좌국 북쪽 방향]
    NR -->|동쪽 Whitecrest Saddle| ME[Maerith 접경]
    NR -->|남쪽 기슭| TH[Thaloss 왕국 남부 평원 진입]
```
