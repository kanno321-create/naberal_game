---
title: "알드릭 왕국 (Kingdom of Aldric) — 전체 개요 및 인덱스"
type: overview
...
```mermaid
graph TD
    K[국왕 — 호반 왕조] --> D1[Duchy of Lonwynshire]
    K --> D2[Duchy of Lowenmere]
    K --> D3[Duchy of Coastfen]
    D1 --> C1[Lonwyn Basin 북부 백작령 × 4~5]
    D2 --> C2[Lowen 강 하류 백작령 × 3~4]
    D3 --> C3[서남 해안 백작령 × 2~3]
```
