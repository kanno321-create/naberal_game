...
```mermaid
graph LR
    AL[Aldren 왕세자] -->|존경하나 의견 충돌| TH[Thormund II 왕]
    AL -->|깊은 유대| AE[Aelindra 왕비]
    AL -->|경쟁·우애 혼재| SV[Solvane 왕녀]
    AL -->|멘토| GV[Greygate 공작 Kaerv — 군사 교관]
    AL -->|불편| CD[대성당 주교 — 교황청 압력]
```
