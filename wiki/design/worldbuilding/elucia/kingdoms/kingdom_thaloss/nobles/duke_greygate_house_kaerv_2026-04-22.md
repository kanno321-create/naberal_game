...
```mermaid
graph TD
    EV[Edric Kaerv 공작] -->|통행세 독점| GP[Greygate Pass]
    EV -->|구리맥 통제| CM[Greygate 구리 광맥]
    EV -->|수비대 지휘| GK[Greygate 기사단 300명]
    EV -->|대립·균형| TH[Thormund II 왕]
    EV -->|동맹| IB[Ironcleft 공작 Brennar]
```
