---
title: "House Erevorn — Oryn 왕실 가문"
type: house
...
```mermaid
graph TD
    A[초대 연합장 Aldwyn 1세 추정] --> B[... 중간 세대 ...]
    B --> C[11대 Aldwyn Erevorn 선왕]
    C --> D[12대 Erevan Erevorn 현왕]
    D --> E[왕세자 Aldryk Erevorn]
    D --> F[왕녀 Seryn Erevorn]
    D --> G[왕자 Caelwyn Erevorn]
    H[Aldric 왕국 공주] -->|혼인 동맹| D
```
