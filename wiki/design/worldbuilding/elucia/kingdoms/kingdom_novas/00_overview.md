...
```mermaid
graph TD
    KN[Novas 왕국<br/>왕도 Duskgate]
    D1[공작령 Duskwatch<br/>왕도·관문 통제]
    D2[공작령 Moorfield<br/>남동 구릉·목축]
    D3[공작령 Azimfront<br/>Azim Pass 진입부]
    C1[백작령 ×4~5<br/>Duskwatch 배속]
    C2[백작령 ×3~4<br/>Moorfield 배속]
    C3[백작령 ×3~4<br/>Azimfront 배속]
    KN --> D1 --> C1
    KN --> D2 --> C2
    KN --> D3 --> C3
```
