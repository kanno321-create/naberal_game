...
```mermaid
graph LR
    AU[Aurion Plain 300K km²] -->|최대 산출| EC[성좌국 경제 기반]
    AU -->|Eloryn·Auravel 관개| AG[농업 잉여 생산]
    AG -->|세수| CH[교황청 권력 유지]
    SO[Soranth Plain 160K km²] -->|남부 보급| AZ[Azim Pass 방향 물자]
    VA[Vaelin Plain 120K km²] -->|북방 방어| NR[Norvend 방어선 지원]
    VA -->|기마 전통| KN[Vaelin 기사단 추정]
```
