...
graph TD
    ...
    Q1 -->|예| Q2{규모?}
    Q1 -->|아니오| Q3{산악/구릉?}
    Q2 -->|항구도시| PORT[-port·-haven]
    Q2 -->|호변도시| MERE[-mere·-lyn]
    Q2 -->|강변마을| FORD[-ford·-bridge]
    Q2 -->|습지마을| FEN[-wick·-fen]
    Q3 -->|예| Q4{규모?}
    Q3 -->|아니오| Q5{평원?}
    Q4 -->|요새도시| GARD[-gard·-held·-holm]
    Q4 -->|협곡마을| COOMBE[-coombe·-gate]
    Q5 -->|예| Q6{규모?}
    Q5 -->|아니오| GENERIC[-ton·-ham·-end]
    Q6 -->|중도시| HEIM[-heim·-stow]
    Q6 -->|마을| WICK[-wick·-well·-cross]
```
