---
title: "Elucia–Karzor 동서 대륙 관계 전반 개요"
layer: 2
canon_tier: detail
...
type: relation
relation_type: intercontinental_overview
parties: [Choir_of_Elucia, Karzor_Dynasty]
created: 2026-04-22
...
```mermaid
graph TD
    EL[Elucia 서쪽 대륙<br/>인간 75% · 성좌국 지배]
    KA[Karzor 동쪽 대륙<br/>타종족 75% · 왕조 15 자치구]
    NOM[Nomen 섬<br/>중립·반무법지대]
    AZI[Azim Pass<br/>유일한 육지 연결]
    VEI[Veilglass 얼음섬<br/>북쪽 목표 자원]
    
    EL <-->|Nomen 쟁탈 분쟁| NOM
    KA <-->|Nomen 쟁탈 분쟁| NOM
    EL <-->|Azim Pass 이중 통행세| AZI
    KA <-->|Azim Pass 이중 통행세| AZI
    NOM -->|유일한 항로 기점| VEI
