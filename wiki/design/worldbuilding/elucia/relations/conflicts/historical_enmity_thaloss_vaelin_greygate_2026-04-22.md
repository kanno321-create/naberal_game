---
title: "Greygate 고개 역사적 적대 — Thaloss vs Vaelin 세대 간 원한"
type: relation
relation_type: historical_enmity
parties: [Thaloss, Vaelin]
created: 2026-04-22
updated: 2026-04-22
...
```mermaid
graph TD
    GEO[Norvend 산맥<br/>물리적 장벽]
    TH[Thaloss<br/>고개 독점 왕조]
    VA[Vaelin<br/>북방 이동로 의존 왕조]
    MO[Moran<br/>Vaelin 연대 이해관계]
    SOL[성좌국·교황청<br/>중재자 겸 이용자]
    ...
    VA -->|연대| MO
    MO -->|공동 압박| TH
    SOL -->|동맹 중재 대가<br/>양측 성좌세 협상력 약화| TH
    SOL -.->|동맹 중재 대가| VA
```
