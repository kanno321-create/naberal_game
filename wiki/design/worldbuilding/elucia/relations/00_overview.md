...
inputs:
  ...
  - wiki/design/worldbuilding/elucia/roads/highway_azim_pass_2026-04-22.md
...
```mermaid
graph TD
    SOL[성좌국 Choir of Elucia<br/>Solaris]
    VAE[Vaelin 대왕국<br/>북부 평원]
    MOR[Moran 대왕국<br/>북서 해안]
    THA[Thaloss 대왕국<br/>북부 산맥]
    ILA[Ilaris 중왕국<br/>서해안]
    CER[Ceren 소왕국<br/>서남 습지]
    ORY[Oryn 중왕국<br/>동부 숲]
    MAE[Maerith 중왕국<br/>북동 고지]
    SYL[Sylren 중왕국<br/>남중앙]
    NOV[Novas 소왕국<br/>남동 국경]
    ALD[Aldric 소왕국<br/>남서 호수]
    KAR[Karzor 왕조<br/>동쪽 대륙]
