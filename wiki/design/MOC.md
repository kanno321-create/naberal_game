...
| [[brainstorm_2026-04-21]] | **설계 원전 (原典)** — 2026-04-21 대표님 브레인스토밍 세션 박제. 과해석 정정 10건 · 작가 피드백 3건 · 세계관 철학 3조 · 종족 생태학 · 신앙 경제학 쌍방 구조 · 의지결 시스템 · 대표님 원문 인용 40+건. **Rev.3 통합 작업의 인용 기준** | 🔒 원안 보존 |
| [[game_setting_complete_2026-04-21]] | **종합 설정 스냅샷** — NotebookLM 업로드·외부 작가 공유용. 12개 섹션 (세계관 철학 · 설계 헌법 · 우주론 · 행성 시간축 · 종족 · 캐릭터 · 스토리 · 게임플레이 · 의지결 · 엔드게임 · 참조작 · 미확정 10건). 과해석 정정 10건 포함 | 📤 외부 공유용 |
